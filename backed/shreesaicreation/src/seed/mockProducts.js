export const MOCK_PRODUCTS = [
  {
    ...
    relatedSlugs: ["aurora-gold-chandelier", "luxury-oval-chandelier"]
  },
  {
    ...
    relatedSlugs: ["royal-crystal-chandelier", "modern-ring-chandelier"]
  },
  {
  ...
  },
  {
    ...
    relatedSlugs: ["royal-crystal-chandelier", "empire-crystal-chandelier"]
  },
  {
    ...
    relatedSlugs: ["royal-crystal-chandelier", "luxury-oval-chandelier"]
  },
  {
    ...
    relatedSlugs: ["orion-ring-pendant", "stellar-drip-multi-light-pendant", "linear-solstice-dining-pendant"]
  },
  {
    ...
    categoryName: "Indoor Wall Lamps",
    price: 1850,
    discount: 10,
    rating: 4.8,
    ...
    relatedSlugs: ["aura-alabaster-linear-pendant", "monolith-bronze-sconce"]
  },
  {
    ...
    categoryName: "Internal Pendant Lights",
    price: 3200,
    discount: 0,
    rating: 4.7,
    ...
    relatedSlugs: ["shree-sai-cascade-chandelier", "linear-solstice-dining-pendant"]
  },
  {
    ...
    relatedSlugs: ["shree-sai-cascade-chandelier", "orion-ring-pendant", "linear-solstice-dining-pendant"]
  },
  {
    ...
    relatedSlugs: ["alabaster-eclipse-sconce", "monolith-bronze-sconce"]
  },
  {
  ...
  },
  {
    ...
    description: "An organic linear pendant light carved from authentic natural alabaster. Hanging from sleek brass cords, Aura projects a warm, organic glow, highlighting the natural mineral formations of the stone.",
    categoryName: "Linear Lights",
    price: 1250,
    discount: 0,
    rating: 4.8,
  ...
  },
  {
    ...
    categoryName: "Outdoor Wall Lamps",
    price: 1650,
    discount: 0,
    rating: 4.7,
    ...
    relatedSlugs: ["alabaster-eclipse-sconce", "aura-alabaster-linear-pendant"]
  },
  {
    ...
    relatedSlugs: ["royal-crystal-chandelier", "orion-ring-pendant", "stellar-drip-multi-light-pendant"]
  }
];
